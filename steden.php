<?php require_once "template/default.php" ?>
      ...
      <li class="header-item"><a href="/">Home</a></li>
        <li class="header-item" id="portfolio"><a href="#">Portfolio</a>
            <ul id="dropdown">
                ...
                <li class="header-item"><a href="#">Steden</a></li>
  ...
  <div class="container">
     <div class="container3">
            ...
            <?php
                $dir = new DirectoryIterator(dirname("./img/steden/steden"));
                foreach ($dir as $fileinfo) {
                    if (!$fileinfo->isDot()) {
                        echo "<div class='viewpic mb-3 pics'>
                                <img alt='picture' src='img/steden/".$fileinfo->getFilename()."' class='img-fluid fancybox' data-big='img/steden/".$fileinfo->getFilename()."' />
                              </div>";
                    }
                }
            ?>
