<?php require_once "template/default.php" ?>
    ...
    <ul id="header-items">
      <li class="header-item"><a href="/">Home</a></li>
        <li class="header-item" id="portfolio"><a href="#">Portfolio</a>
            <ul id="dropdown">
                <li class="header-item"><a href="#">Portretten</a></li>
  ...
  <div class="container">
     <div class="container3">
            ...
            <?php
                $dir = new DirectoryIterator(dirname("./img/portretten/portretten"));
                foreach ($dir as $fileinfo) {
                    if (!$fileinfo->isDot()) {
                        echo "<div class='viewpic mb-3 pics'>
                                <img alt='picture' src='img/portretten/".$fileinfo->getFilename()."' class='img-fluid fancybox' data-big='img/portretten/".$fileinfo->getFilename()."' />
                            </div>";
                    }
                }
            ?>
