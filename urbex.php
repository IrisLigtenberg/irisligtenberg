<?php require_once "template/default.php" ?>
      ...
      <li class="header-item"><a href="/">Home</a></li>
        <li class="header-item" id="portfolio"><a href="#">Portfolio</a>
            <ul id="dropdown">
                ...
                <li class="header-item"><a href="#">Urbex</a></li>
            </ul>
        </li>
  ...
  <div class="container">
     <div class="container3">
            ...
            <?php
                $dir = new DirectoryIterator(dirname("./img/urbex/urbex"));
                foreach ($dir as $fileinfo) {
                    if (!$fileinfo->isDot()) {
                        echo "<div class='viewpic mb-3 pics'>
                                <img alt='picture' src='img/urbex/".$fileinfo->getFilename()."' class='img-fluid fancybox' data-big='img/urbex/".$fileinfo->getFilename()."' />
                            </div>";
                    }
                }
            ?>
